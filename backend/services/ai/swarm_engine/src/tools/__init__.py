...
def _discover_subclasses() -> list[type[BaseTool]]:
    """Return concrete BaseTool subclasses tailored for the Indian Market."""
    from src.tools.indian_market_tools import (
        SearchStockTool, GetHistoricalCandlesTool, GetTechnicalIndicatorsTool,
        RunStrategyTool, RunScannerTool, GetSectorDataTool, BacktestStrategyTool,
        PortfolioAnalysisTool, RiskAnalysisTool, MarketBreadthTool, WatchlistTool
    )
    ...
    from src.tools.goal_tool import (
        StartResearchGoalTool, GetResearchGoalTool, AddGoalEvidenceTool, UpdateResearchGoalStatusTool
    )
    ...
    return [
        ...
        RunStrategyTool, RunScannerTool, GetSectorDataTool, BacktestStrategyTool,
        PortfolioAnalysisTool, RiskAnalysisTool, MarketBreadthTool, WatchlistTool,
        RememberTool, SwarmTool, StartResearchGoalTool, GetResearchGoalTool,
        AddGoalEvidenceTool, UpdateResearchGoalStatusTool, RunResearchAutopilotTool,
