...
PRICE_ENDPOINTS = [
    ...
    "/api/ai/top5-picks",
    "/api/ai/top3-picks",
    "/api/ai/momentum-scanner",
    "/api/ai/mean-reversion",
    "/api/ai/gap-scanner",
    "/api/ai/relative-strength",
    "/api/ai/vwap-scanner",
    "/api/ai/sr-bounce",
    "/api/ai/momentum",
    "/api/ai/vwap",
    "/api/v2/scanner/momentum",
    "/api/v2/scanner/breakout",
    "/api/v2/scanner/reversal",
    "/api/v2/scanner/trendfinder",
    ...
    "/api/scanner/breakout",
    "/api/scanner/reversal",
    "/api/scanner/trendfinder",
]
...
ENDPOINTS = [
    ...
    {"path": "/health", "method": "GET", "auth": False, "category": "System"},
    {"path": "/ready", "method": "GET", "auth": False, "category": "System"},
    ...
    {"path": "/api/upstox/market-quote/RELIANCE", "method": "GET", "auth": True, "category": "Upstox"},
    ...
    # Heatmap
    {"path": "/api/heatmap/sectors", "method": "GET", "auth": True, "category": "Heatmap"},
    {"path": "/api/heatmap/sector/IT", "method": "GET", "auth": True, "category": "Heatmap"},
    
    # AI Scanners
    {"path": "/api/ai/strategies", "method": "GET", "auth": True, "category": "AI"},
    {"path": "/api/ai/market-analysis", "method": "GET", "auth": True, "category": "AI"},
    {"path": "/api/ai/sentiment", "method": "GET", "auth": True, "category": "AI", "params": {"symbol": "RELIANCE"}},
    {"path": "/api/ai/trend-finder", "method": "GET", "auth": True, "category": "AI"},
    {"path": "/api/ai/breakout-detector", "method": "GET", "auth": True, "category": "AI"},
    {"path": "/api/ai/top5-picks", "method": "GET", "auth": True, "category": "AI"},
    {"path": "/api/ai/top3-picks", "method": "GET", "auth": True, "category": "AI"},
    {"path": "/api/ai/momentum-scanner", "method": "GET", "auth": True, "category": "AI"},
    {"path": "/api/ai/mean-reversion", "method": "GET", "auth": True, "category": "AI"},
    {"path": "/api/ai/gap-scanner", "method": "GET", "auth": True, "category": "AI"},
    {"path": "/api/ai/relative-strength", "method": "GET", "auth": True, "category": "AI"},
    {"path": "/api/ai/vwap-scanner", "method": "GET", "auth": True, "category": "AI"},
    {"path": "/api/ai/sr-bounce", "method": "GET", "auth": True, "category": "AI"},
    {"path": "/api/ai/momentum", "method": "GET", "auth": True, "category": "AI"},
    {"path": "/api/ai/vwap", "method": "GET", "auth": True, "category": "AI"},
    {"path": "/api/ai/prompt", "method": "POST", "auth": True, "category": "AI", "body": {"prompt": "What are the top momentum stocks today?"}},
    {"path": "/api/ai/command", "method": "POST", "auth": True, "category": "AI", "body": {"command": "show top gainers"}},
    ...
    {"path": "/api/settings/", "method": "GET", "auth": True, "category": "Settings"},
    
    # Algorithms
    {"path": "/api/algorithms/", "method": "GET", "auth": True, "category": "Algorithms"},
    
    # Agentic Bot
    {"path": "/api/agentic-bot/analyze", "method": "POST", "auth": True, "category": "AgenticBot", "body": {"prompt": "Analyze RELIANCE for swing trading"}},
    
    # Engine Performance
    {"path": "/api/engines/test", "method": "GET", "auth": False, "category": "Engines"},
    {"path": "/api/engines/performance", "method": "GET", "auth": True, "category": "Engines"},
    {"path": "/api/engines/performance/momentum", "method": "GET", "auth": True, "category": "Engines"},
    
    # Quant Bot
    {"path": "/api/quant/strategies", "method": "GET", "auth": True, "category": "Quant"},
    {"path": "/api/quant/symbols", "method": "GET", "auth": True, "category": "Quant"},
    
    # Scanner
    {"path": "/api/scanner/strategies", "method": "GET", "auth": True, "category": "Scanner"},
    {"path": "/api/scanner/indices", "method": "GET", "auth": True, "category": "Scanner"},
    {"path": "/api/scanner/timeframes", "method": "GET", "auth": True, "category": "Scanner"},
    {"path": "/api/scanner/presets", "method": "GET", "auth": True, "category": "Scanner"},
    {"path": "/api/scanner/momentum", "method": "GET", "auth": True, "category": "Scanner"},
    {"path": "/api/scanner/breakout", "method": "GET", "auth": True, "category": "Scanner"},
    {"path": "/api/scanner/reversal", "method": "GET", "auth": True, "category": "Scanner"},
    {"path": "/api/scanner/trendfinder", "method": "GET", "auth": True, "category": "Scanner"},
    {"path": "/api/scanner/week52-breakouts", "method": "GET", "auth": True, "category": "Scanner"},
    {"path": "/api/scanner/momentum/status", "method": "GET", "auth": True, "category": "Scanner"},
    
    # Market
    {"path": "/api/market/nifty100/top-movers", "method": "GET", "auth": False, "category": "Market"},
    {"path": "/api/market/nifty100/status", "method": "GET", "auth": False, "category": "Market"},
    {"path": "/api/market/top-movers", "method": "GET", "auth": False, "category": "Market"},
    {"path": "/api/market/orchestrator/status", "method": "GET", "auth": False, "category": "Market"},
    {"path": "/api/market/health", "method": "GET", "auth": False, "category": "Market"},
    {"path": "/api/market/heatmap", "method": "GET", "auth": True, "category": "Market"},
    {"path": "/api/market/sector-stocks/IT", "method": "GET", "auth": True, "category": "Market"},
    
    # Walk-Forward
    {"path": "/api/v1/walk-forward/strategies", "method": "GET", "auth": True, "category": "WalkForward"},
    {"path": "/api/v1/walk-forward/presets", "method": "GET", "auth": True, "category": "WalkForward"},
    {"path": "/api/v1/walk-forward/symbols", "method": "GET", "auth": True, "category": "WalkForward"},
    
    # Experiment Lab
    {"path": "/api/v1/experiment-lab/", "method": "GET", "auth": False, "category": "ExperimentLab"},
    {"path": "/api/v1/experiment-lab/strategies", "method": "GET", "auth": False, "category": "ExperimentLab"},
    {"path": "/api/v1/experiment-lab/strategies/1", "method": "GET", "auth": False, "category": "ExperimentLab"},
    {"path": "/api/v1/experiment-lab/categories", "method": "GET", "auth": False, "category": "ExperimentLab"},
    {"path": "/api/v1/experiment-lab/symbols", "method": "GET", "auth": False, "category": "ExperimentLab"},
    {"path": "/api/v1/experiment-lab/timeframes", "method": "GET", "auth": False, "category": "ExperimentLab"},
    
    # ETL
    {"path": "/api/v1/etl/status", "method": "GET", "auth": False, "category": "ETL"},
    
    # Backtest Strategies
    {"path": "/api/v1/backtest/strategies/list", "method": "GET", "auth": True, "category": "Backtest"},
    {"path": "/api/v1/backtest/strategies/by-tier", "method": "GET", "auth": True, "category": "Backtest"},
    {"path": "/api/v1/backtest/strategies/search", "method": "GET", "auth": True, "category": "Backtest", "params": {"query": "momentum"}},
    {"path": "/api/v1/backtest/strategies/trend_finder", "method": "GET", "auth": True, "category": "Backtest"},
    
    # ML Forecast
    {"path": "/api/v1/ml/status", "method": "GET", "auth": True, "category": "ML"},
    {"path": "/api/v1/ml/symbols", "method": "GET", "auth": True, "category": "ML"},
    {"path": "/api/v1/ml/predict", "method": "GET", "auth": True, "category": "ML", "params": {"symbol": "RELIANCE", "timeframe": "1d", "horizon": 5}},
    
    # HP Scanner v2
    {"path": "/api/v2/scanner/momentum", "method": "GET", "auth": False, "category": "HPScannerV2"},
    {"path": "/api/v2/scanner/breakout", "method": "GET", "auth": False, "category": "HPScannerV2"},
    {"path": "/api/v2/scanner/reversal", "method": "GET", "auth": False, "category": "HPScannerV2"},
    {"path": "/api/v2/scanner/trendfinder", "method": "GET", "auth": False, "category": "HPScannerV2"},
    {"path": "/api/v2/scanner/signals", "method": "GET", "auth": False, "category": "HPScannerV2"},
    {"path": "/api/v2/scanner/symbol/RELIANCE", "method": "GET", "auth": False, "category": "HPScannerV2"},
    {"path": "/api/v2/scanner/status", "method": "GET", "auth": False, "category": "HPScannerV2"},
    
    # HP Scanner v3
    {"path": "/api/v3/scanner/momentum", "method": "GET", "auth": False, "category": "HPScannerV3"},
    {"path": "/api/v3/scanner/breakout", "method": "GET", "auth": False, "category": "HPScannerV3"},
    {"path": "/api/v3/scanner/reversal", "method": "GET", "auth": False, "category": "HPScannerV3"},
    {"path": "/api/v3/scanner/signals", "method": "GET", "auth": False, "category": "HPScannerV3"},
    {"path": "/api/v3/scanner/snapshots", "method": "GET", "auth": False, "category": "HPScannerV3"},
    {"path": "/api/v3/scanner/symbol/RELIANCE", "method": "GET", "auth": False, "category": "HPScannerV3"},
    {"path": "/api/v3/scanner/status", "method": "GET", "auth": False, "category": "HPScannerV3"},
    {"path": "/api/v3/scanner/metrics", "method": "GET", "auth": False, "category": "HPScannerV3"},
    ...
    {"path": "/api/analytics/volatility/RELIANCE", "method": "GET", "auth": True, "category": "Analytics"},
    {"path": "/api/analytics/support-resistance/RELIANCE", "method": "GET", "auth": True, "category": "Analytics"},
    ...
    {"path": "/api/analytics/indicators/latest/RELIANCE", "method": "GET", "auth": True, "category": "Analytics"},
]
...
class UpstoxVerifier:
    ...
    async def get_price(self, session: aiohttp.ClientSession, symbol: str) -> Optional[float]:
        ...
        # Build instrument key (assuming NSE equity)
            ...
            async with session.get(url, headers=headers, params=params, timeout=5) as resp:
                if resp.status == 200:
                    ...
                    if data.get("status") == "success" and "data" in data:
                        ltp_data = data["data"].get(instrument_key, {})
                        price = ltp_data.get("last_price")
                        if price:
