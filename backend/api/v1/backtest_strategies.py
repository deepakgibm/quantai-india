...
async def get_strategy_details(
    ...
    try:
        ...
        if not strategy:
            raise HTTPException(
                status_code=404,
                detail=f"Strategy '{strategy_name}' not found. Use /backtest/strategies/list to see available strategies."
            )
